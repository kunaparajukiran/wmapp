...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SpringYoman@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SpringYoman API";

        private String description = "SpringYoman API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SpringYoman";
